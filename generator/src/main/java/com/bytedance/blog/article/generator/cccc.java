/*
package com.bytedance.blog.article.generator;
...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        pc.setParent("com.bytedance.blog.article"); //父包名
        pc.setController(MODULE_NAME+".controller"); // com.zrrd.blog.aritcle.controller
        ...
        pc.setEntity("entities");//实体类存储包名 com.zrrd.blog.entities
        ...
        strategy.setTablePrefix("zrrd_"); // 去掉表前缀
